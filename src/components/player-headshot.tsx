...
export function PlayerHeadshot({
  ...
  return <span aria-hidden="true" className={cn("inline-flex h-12 w-12 shrink-0 items-center justify-center overflow-hidden rounded-full border bg-muted align-middle", className)}>
